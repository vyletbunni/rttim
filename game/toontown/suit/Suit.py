#CRAZYBOT-TEMP --- Look for this when changing values
...
SuitDialogArray = []
SkelSuitDialogArray = []
AllSuits = (('walk', 'walk'), ('run', 'walk'), ('neutral', 'neutral'), ('throw-paper', 'throw-paper', 5))
...
cc = (('speak', 'speak', 5),
 ...
 ('phone', 'phone', 3.5),
 ('finger-wag', 'finger-wag', 5))
tm = (('throw-paper', 'throw-paper', 5), ('speak', 'speak', 5),
 ('throw-paper', 'throw-paper', 5),
 ('pickpocket', 'pickpocket', 5),
 ('roll-o-dex', 'roll-o-dex', 5),
 ('finger-wag', 'finger-wag', 5))
nd = (('throw-paper', 'throw-paper', 5), ('pickpocket', 'pickpocket', 5),
 ('roll-o-dex', 'roll-o-dex', 5),
 ('magic3', 'magic3', 5),
 ('smile', 'smile', 5))
gh = (('throw-paper', 'throw-paper', 5), ('speak', 'speak', 5), ('pen-squirt', 'fountain-pen', 5), ('rubber-stamp', 'rubber-stamp', 5))
ms = (('effort', 'effort', 5),
 ('throw-paper', 'throw-paper', 5),
 ('stomp', 'stomp', 5),
 ('quick-jump', 'jump', 6))
...
bw = (('finger-wag', 'fingerwag', 5),
 ...
 ('throw-object', 'throw-object', 5),
 ('throw-paper', 'throw-paper', 5))
bfs = (('throw-paper', 'throw-paper', 5), ('throw-object', 'throw-object', 5), ('glower', 'glower', 5), ('magic3', 'magic3', 5))
pb = (('magic1', 'magic1', 5),
 ('song-and-dance', 'song-and-dance', 8),
 ('glower', 'glower', 5),
 ('finger-wag', 'fingerwag', 5),
...
sf = (('speak', 'speak', 5),
 ...
 ('cigar-smoke', 'cigar-smoke', 8),
 ('smile', 'smile', 5))
mr = (('glower', 'glower', 5), ('magic2', 'magic2', 5))
dj = (('glower', 'glower', 5),)
bm = (('magic1', 'magic1', 5), ('hold-pencil', 'hold-pencil', 5), ('throw-object', 'throw-object', 5))
nut = (('speak', 'speak', 5),)
kh = (('glower', 'glower', 5), ('speak', 'speak', 5))
sck = (('speak', 'speak', 5),)
glc = (('speak', 'speak', 5), ('magic1', 'magic1', 5))
jdk = (('magic1', 'magic1', 5), ('cigar-smoke', 'cigar-smoke', 8))
bk = (('magic1', 'magic1', 5), ('golf-club-swing', 'golf-club-swing', 5), ('glower', 'glower', 5))
ph = (('glower', 'glower', 5), ('shredder', 'shredder', 3.5))
...
SuitParts = ['phase_3.5/models/char/suitA-mod',
            ...
            'phase_4/models/minigames/pineapple']
...
class Suit(Avatar.Avatar):
    ...
    def generateSuit(self):
        ...
        if dna.name in SuitGlobals.suitProperties:
            ...
            self.handColor = SuitGlobals.suitProperties[dna.name][1]
            ...
            self.getGeomNode().find('**/hands').setColor(self.handColor, 1)
        ...
        self.setBlend(frameBlend=True)
        if dna.name == 'bfs':
            self.makeRentalSuit('m')
        elif dna.name == 'mr':
            self.makeShadowJustice()
        elif dna.name == 'sf':
            self.makeSkeleton()
    ...
    def setSuitClothes(self, modelRoot = None):
        ...
        modelRoot.find('**/hands').setColor(self.handColor, 1)
    ...
    def makeWaiter(self, modelRoot = None):
        if not modelRoot:
            modelRoot = self
        self.isWaiter = 1
        torsoTex = loader.loadTexture('phase_3.5/maps/waiter_%s_blazer.jpg' % self.style.dept)
        torsoTex.setMinfilter(Texture.FTLinearMipmapLinear)
        torsoTex.setMagfilter(Texture.FTLinear)
    ...
    def makeShadowJustice(self, modelRoot = None):
        if not modelRoot:
            modelRoot = self
        self.isSJ = 1
        torsoTex = loader.loadTexture('phase_3.5/maps/sj_blazer.jpg')
        torsoTex.setMinfilter(Texture.FTLinearMipmapLinear)
        torsoTex.setMagfilter(Texture.FTLinear)
        legTex = loader.loadTexture('phase_3.5/maps/sj_leg.jpg')
        legTex.setMinfilter(Texture.FTLinearMipmapLinear)
        legTex.setMagfilter(Texture.FTLinear)
        armTex = loader.loadTexture('phase_3.5/maps/sj_sleeve.jpg')
        armTex.setMinfilter(Texture.FTLinearMipmapLinear)
        armTex.setMagfilter(Texture.FTLinear)
        modelRoot.find('**/torso').setTexture(torsoTex, 1)
        modelRoot.find('**/arms').setTexture(armTex, 1)
    ...
    def makeRentalSuit(self, suitType, modelRoot = None):
        ...
        if suitType == 's' or self.style.name == 'bfs':
    ...
    def makeRentalSuitLost(self, modelRoot = None):
        if not modelRoot:
            modelRoot = self
        self.isRental = 1
        torsoTex = loader.loadTexture('phase_3.5/maps/tt_t_ene_sellbotRental_blazer.jpg')
    ...
    def generateHead(self, headType):
        ...
        if headType == 'pencilpusher' or headType == 'loanshark' or headType == 'beancounter' and self.style.body == 'a':
            filepath = 'phase_4/models/char/suitB-heads'
        elif headType == 'tightwad' and self.style.body == 'a':
            filepath = 'phase_3.5/models/char/suitC-heads'
        elif headType == 'numbercruncher' and self.style.body == 'b':
            filepath = 'phase_4/models/char/suitA-heads'
        elif headType == 'numbercruncher' and self.style.body == 'c':
            filepath = 'phase_4/models/char/suitA-heads'
        elif headType == 'pineapple':
            filepath = 'phase_4/models/minigames/pineapple'
        else:
        ...
        if self.loseActor == None:
            if not self.isSkeleton:
                ...
                if self.isWaiter:
                    ...
                    self.makeRentalSuitLost(self.loseActor)
                elif self.isSJ:
                    self.makeShadowJusice(self.loseActor)
                else:
                ...
                if self.style.name == 'sf':
                    self.loseActor.setColor(VBase4(1, .29, .6, 1))
                elif self.style.name == 'mr':
                    self.loseActor.setColor(VBase4(.25, .25, .25, 1))
