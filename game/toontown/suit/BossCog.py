...
class BossCog(Avatar.Avatar):
    ...
    def generateBossCog(self):
        ...
        self.doorA = self.__setupDoor('**/joint_doorFront', 'doorA', self.doorACallback, VBase3(0, 0, 0), VBase3(0, 0, -80), CollisionPolygon(Point3(5, -4, 0.32), Point3(0, -4, 0), Point3(0, 4, 0), Point3(5, 4, 0.32)), uniqueName='DoorA')
        self.doorB = self.__setupDoor('**/joint_doorRear', 'doorB', self.doorBCallback, VBase3(0, 0, 0), VBase3(0, 0, 80), CollisionPolygon(Point3(-5, 4, 0.84), Point3(0, 4, 0), Point3(0, -4, 0), Point3(-5, -4, 0.84)), uniqueName='DoorB')
    ...
    def __setupDoor(self, jointName, name, callback, openedHpr, closedHpr, cPoly, uniqueName='EbicDoor'):
        self.uniqueName = uniqueName
