...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  'pb': (3.35 / aSize, SuitDNA.corpPolyColor, ['pencilpusher'], '', 5.0),
                  # Lawbots
                  ...
                  'mr': (8.0 / aSize, VBase4(0.15, 0.15, 0.15, 1.0), ['beancounter'], 'associate.jpg', 10.0),
                  # Cashbots
                  ...
                  'bfs': (6.5 / aSize, VBase4(0.5, 0.85, 0.75, 1.0), ['loanshark'], '', 8.58),
                  # Sellbots
                  ...
                  'sf': (5.75 / aSize, SuitDNA.salesPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  # Crazybots
                  'dj': (3.5 / cSize, VBase4(0.5, 0.0, 0.0, 1.0), ['tightwad'], 'desk-jockey.jpg', 4.63),
                  'bm': (4.05 / bSize, VBase4(1.0, 1.0, 1.0, 1.0), ['movershaker'], 'blind-mouse.jpg', 4.8),
                  'nut': (4.5 / aSize, SuitDNA.corpPolyColor, ['tightwad'], 'nutshell.jpg', 5.0),
                  'kh': (4.8 / aSize, SuitDNA.corpPolyColor, ['numbercruncher'], 'knucklehead.jpg', 5.355),
                  'sck': (5.5 / cSize, VBase4(1.0, 0.5, 0.0, 1.0), ['flunky'], 'smart-cookie.jpg', 6.25),
                  'glc': (5.8 / bSize, VBase4(0.0, 1.0, 0.0, 1.0), ['numbercruncher'], 'glitch.jpg', 6.5),
                  'jdk': (6.25 / aSize, VBase4(0.0, 0.0, 0.0, 1.0), ['numbercruncher'], 'jack-donkey.jpg', 7.5),
                  'bk': (7.25 / aSize, VBase4(1.0, 0.5, 0.0, 1.0), ['bigcheese'], 'big-kahuna.jpg', 8.5),
                  'ph': (8.0 / cSize, VBase4(0.713, 0.643, 0.305, 1.0), ['pineapple'], '', 9.5)
                  }
