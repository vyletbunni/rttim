...
def __throwPie(throw, delay, hitCount, showCannon = 1):
    ...
    if toon.isDisguised:
        toonTrack.append(Wait(1))
        toonTrack.append(ActorInterval(toon.suit, 'speak', endFrame=29))
        toonTrack.append(ActorInterval(toon.suit, 'speak', startFrame=29, endFrame=0))
        toonTrack.append(ActorInterval(toon.suit, 'victory', duration=5.75))
