...
class DisplaySettingsDialog(DirectFrame, StateData.StateData):
    ...
    def load(self):
        ...
        self.screenSizeWidthInput = DirectEntry(parent=self, relief=DGG.GROOVE, scale=0.08, pos=(0, 0, 0.025), borderWidth=(0.05, 0.05), frameColor=((1, 1, 1, 1), (1, 1, 1, 1), (0.5, 0.5, 0.5, 0.5)), state=DGG.NORMAL, text_align=TextNode.ALeft, text_scale=TTLocalizer.OPCodesInputTextScale, width=10.5, numLines=1, focus=1, backgroundFocus=0, cursorKeys=1, text_fg=(0, 0, 0, 1), suppressMouse=1, autoCapitalize=0)
        self.screenSizeHeightInput = DirectEntry(parent=self, relief=DGG.GROOVE, scale=0.08, pos=(0, 0, -0.1), borderWidth=(0.05, 0.05), frameColor=((1, 1, 1, 1), (1, 1, 1, 1), (0.5, 0.5, 0.5, 0.5)), state=DGG.NORMAL, text_align=TextNode.ALeft, text_scale=TTLocalizer.OPCodesInputTextScale, width=10.5, numLines=1, focus=1, backgroundFocus=0, cursorKeys=1, text_fg=(0, 0, 0, 1), suppressMouse=1, autoCapitalize=0)
