...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None, hat=None, glasses=None, backpack=None, shoes=None):
    ...
    import DistributedNPCSecretAI
    import DistributedNPCPrizeClerkAI
...
NPCToonDict = {20000: (-1,
 ...
 2020: (2513,
        ...
        1,
        NPC_SCIENTIST),
 2023: (ToontownGlobals.ToontownCentral,
        'untitled',
        ('rls',
        'l',
        'm',
...
99992: (-1,
        ...
        ('dss',
         ...
         26,
         26,
         ToonDNA.Shirts.index('phase_4/maps/tt_t_chr_avt_shirt_sellbotCrusher.jpg'),
         27,
         ToonDNA.Sleeves.index('phase_4/maps/tt_t_chr_avt_shirtSleeve_sellbotCrusher.jpg'),
         27,
         ToonDNA.BoyShorts.index('phase_4/maps/tt_t_chr_avt_shorts_sellbotCrusher.jpg'),
         27),
        'm',
        0,
        NPC_REGULAR),
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
 ...
 1329: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 99990: (ToontownBattleGlobals.TRAP_TRACK,
         3,
         199,
         5),
 99991: (ToontownBattleGlobals.SOUND_TRACK,
         3,
         72,
         4),
 99992: (ToontownBattleGlobals.DROP_TRACK,
         2,
         90,
         4),
 99993: (ToontownBattleGlobals.SOUND_TRACK,
         5,
         180,
         5),
 99994: (ToontownBattleGlobals.NPC_TOONS_HIT,
         0,
         0,
         5),
 99995: (ToontownBattleGlobals.SOUND_TRACK,
         6,
         200,
         6)}
