...
from toontown.toon.ToonImport import *
    ...
    if not Preloaded:
        ...
        for key in TorsoDict.keys():
            ...
            if key == 's' or key == 'm' or key == 'l':
                ...
                Preloaded[fileRoot+'-1000'] = loader.loadModel('phase_14' + fileRoot + '1000')

                if len(key) > 1:
                    Preloaded[fileRoot+'-500'] = loader.loadModel('phase_14' + fileRoot + '500')
                    Preloaded[fileRoot+'-250'] = loader.loadModel('phase_14' + fileRoot + '250')
            else:
...
def loadDialog():
    ...
    MickeyDialogueArray.append(base.loadSfx('phase_3/audio/dial/mickey.ogg'))
    MickeyDialogueArray.append(base.loadSfx('phase_3/audio/dial/mickey.ogg'))
    MickeyDialogueArray.append(base.loadSfx('phase_3/audio/dial/mickey.ogg'))
    MickeyDialogueArray.append(base.loadSfx('phase_3/audio/dial/mickey.ogg'))
    MickeyDialogueArray.append(base.loadSfx('phase_3/audio/dial/mickey.ogg'))
    ...
    MinnieDialogueArray.append(base.loadSfx('phase_3/audio/dial/minnie.ogg'))
    MinnieDialogueArray.append(base.loadSfx('phase_3/audio/dial/minnie.ogg'))
    MinnieDialogueArray.append(base.loadSfx('phase_3/audio/dial/minnie.ogg'))
    MinnieDialogueArray.append(base.loadSfx('phase_3/audio/dial/minnie.ogg'))
    MinnieDialogueArray.append(base.loadSfx('phase_3/audio/dial/minnie.ogg'))
    ...
    DaisyDialogueArray.append(base.loadSfx('phase_4/audio/dial/daisy.ogg'))
    DaisyDialogueArray.append(base.loadSfx('phase_4/audio/dial/daisy.ogg'))
    DaisyDialogueArray.append(base.loadSfx('phase_4/audio/dial/daisy.ogg'))
    DaisyDialogueArray.append(base.loadSfx('phase_4/audio/dial/daisy.ogg'))
    DaisyDialogueArray.append(base.loadSfx('phase_4/audio/dial/daisy.ogg'))
    ...
    GoofyDialogueArray.append(base.loadSfx('phase_6/audio/dial/goofy.ogg'))
    GoofyDialogueArray.append(base.loadSfx('phase_6/audio/dial/goofy.ogg'))
    GoofyDialogueArray.append(base.loadSfx('phase_6/audio/dial/goofy.ogg'))
    GoofyDialogueArray.append(base.loadSfx('phase_6/audio/dial/goofy.ogg'))
    GoofyDialogueArray.append(base.loadSfx('phase_6/audio/dial/goofy.ogg'))
    ...
    DonaldDialogueArray.append(base.loadSfx('phase_6/audio/dial/donald.ogg'))
    DonaldDialogueArray.append(base.loadSfx('phase_6/audio/dial/donald.ogg'))
    DonaldDialogueArray.append(base.loadSfx('phase_6/audio/dial/donald.ogg'))
    DonaldDialogueArray.append(base.loadSfx('phase_6/audio/dial/donald.ogg'))
    DonaldDialogueArray.append(base.loadSfx('phase_6/audio/dial/donald.ogg'))
    ...
    ChipDialogueArray.append(base.loadSfx('phase_6/audio/dial/chip.ogg'))
    ChipDialogueArray.append(base.loadSfx('phase_6/audio/dial/chip.ogg'))
    ChipDialogueArray.append(base.loadSfx('phase_6/audio/dial/chip.ogg'))
    ChipDialogueArray.append(base.loadSfx('phase_6/audio/dial/chip.ogg'))
    ChipDialogueArray.append(base.loadSfx('phase_6/audio/dial/chip.ogg'))
    ...
    DaleDialogueArray.append(base.loadSfx('phase_6/audio/dial/dale.ogg'))
    DaleDialogueArray.append(base.loadSfx('phase_6/audio/dial/dale.ogg'))
    DaleDialogueArray.append(base.loadSfx('phase_6/audio/dial/dale.ogg'))
    DaleDialogueArray.append(base.loadSfx('phase_6/audio/dial/dale.ogg'))
    DaleDialogueArray.append(base.loadSfx('phase_6/audio/dial/dale.ogg'))
...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def setLODs(self):
        self.setLODNode()
        levelOneIn = base.config.GetInt('lod1-in', 280)
        levelOneOut = base.config.GetInt('lod1-out', 0)
        levelTwoIn = base.config.GetInt('lod2-in', 850)
        levelTwoOut = base.config.GetInt('lod2-out', 280)
        levelThreeIn = base.config.GetInt('lod3-in', 3000)
        levelThreeOut = base.config.GetInt('lod3-out', 850)
    ...
    def getHoleActors(self):
        ...
        holeActor.setBlend(frameBlend=True)
    ...
    def getDialogueArray(self):
        ...
        if self.isTransformed:
            ...
            charType = None
        if self.isDisguised == 1 and self.isCogHead == 1:
            dialogueArray = SuitDialogArray
        elif self.isCogHead == 2:
            dialogueArray = SkelSuitDialogArray
        elif charType == 'mickey' or charType == 'vampire_mickey':
            dialogueArray = MickeyDialogueArray
        elif charType == 'minnie' or charType == 'witch_minnie':
            dialogueArray = MinnieDialogueArray
        elif charType == 'goofy' or charType == 'super_goofy':
            dialogueArray = GoofyDialogueArray
        elif charType == 'donald-wheel' or charType == 'franken_donald':
            dialogueArray = DonaldDialogueArray
        elif charType == 'daisy' or charType == 'sockHop_daisy':
            dialogueArray = DaisyDialogueArray
        elif charType == 'pluto' or charType == 'western_pluto':
            dialogueArray = DogDialogueArray
        elif charType == 'chip' or charType == 'police_chip':
            dialogueArray = ChipDialogueArray
        elif charType == 'dale' or charType == 'jailbird_dale':
            dialogueArray = DaleDialogueArray
        elif charType == 'donald' or charType == 'clarabelle':
            dialogueArray = None
        elif animalType == 'dog':
            dialogueArray = DogDialogueArray
        elif animalType == 'cat':
    ...
    def enterNeutral(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        anim = 'neutral'
        if self.isDisguised:
            self.suit.pose(anim, int(self.getNumFrames(anim) * self.randGen.random()))
            self.suit.loop(anim, restart=0)
    ...
    def enterJump(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        if not self.isDisguised:
            ...
            if self.suit.style.body == 'a':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.29)
            elif self.suit.style.body == 'b':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=1.83)
            elif self.suit.style.body == 'c':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.46)
            else:
    ...
    def enterJumpSquat(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        if not self.isDisguised:
            ...
            self.suit.setPlayRate(animMultiplier, anim)
            if self.suit.style.body == 'a':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.29, endTime=2.625)
            elif self.suit.style.body == 'b':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=1.83, endTime=2.29)
            elif self.suit.style.body == 'c':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.46, endTime=2.79)
            else:
                self.notify.warning('Body type fucked up.')
            self.ebicJumpVariable.start()
        self.setActiveShadow(1)
    ...
    def enterJumpAirborne(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        if not self.isDisguised:
            ...
            self.suit.setPlayRate(animMultiplier, anim)
            if self.suit.style.body == 'a':
                self.suit.pose(anim, 63)
            elif self.suit.style.body == 'b':
                self.suit.pose(anim, 55)
            elif self.suit.style.body == 'c':
                self.suit.pose(anim, 67)
            else:
                self.notify.warning('Body type fucked up.')
        self.setActiveShadow(1)
    ...
    def enterJumpLand(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        if not self.isDisguised:
            ...
            self.suit.setPlayRate(animMultiplier, anim)
            if self.suit.style.body == 'a':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.625)
            elif self.suit.style.body == 'b':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.29, endTime=2.91)
            elif self.suit.style.body == 'c':
                self.ebicJumpVariable = ActorInterval(self.suit, 'slip-forward', startTime=2.79)
            else:
                self.notify.warning('Body type fucked up.')
            self.ebicJumpVariable.start()
        self.setActiveShadow(1)
    ...
    def enterRun(self, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        if self.isDisguised:
            self.suit.loop('run')
            self.suit.setPlayRate(animMultiplier, 'run')
        else:
            self.loop('run')
    ...
    def doNPCEmote(self, emoteIndex, animMultiplier = 1, ts = 0, callback = None, extraArgs = []):
        duration = 0
        self.emoteTrack, duration = Emote.globalEmote.doEmote(self, emoteIndex, ts)
        return
    ...
    def __doInvisibleCE(self, scale, lerpTime):
        if scale == None:
            scale = VBase4(1, 1, 1, 1)
        node = self.getGeomNode()
        if len(self.style.torso) == 2:
            ...
            pieces = self.getPieces(('torso', ('arms', 'neck', 'torso')), ('legs', ('legs', 'feet')), ('head', '+GeomNode'))
        track = Sequence()
        track.append(Func(node.setTransparency, 1))
        for piece in pieces:
            if piece.getName()[:7] == 'muzzle-' and piece.getName()[-8:] != '-neutral':
    ...
    def __doRaymanCE(self, scale, lerpTime):
        if scale == None:
            scale = VBase4(1, 1, 1, 1)
        node = self.getGeomNode()
        pieces = self.getPieces(('torso', ('arms', 'neck')), ('legs', ('legs')))
        track = Sequence()
        track.append(Func(node.setTransparency, 1))
        for piece in pieces:
            track.append(ShowInterval(piece))
    ...
    def __doCheesyEffect(self, effect, lerpTime):
        if effect == ToontownGlobals.CEBigHead:
            ...
            return self.__doInvisibleCE(VBase4(1, 1, 1, 0), lerpTime)
        ...
        elif effect == ToontownGlobals.CERayman:
            return self.__doRaymanCE(VBase4(1, 1, 1, 0), lerpTime)
        elif effect == ToontownGlobals.CEOldInvisible:
    ...
    def __undoCheesyEffect(self, effect, lerpTime):
        ...
        if effect == ToontownGlobals.CEBigLegs:
            ...
            return self.__doInvisibleCE(None, lerpTime)
        elif effect == ToontownGlobals.CEPumpkin:
            ...
            return self.__doRaymanCE(None, lerpTime)
        elif effect == ToontownGlobals.CEInvisible:
            return self.__doPartsColorScale(None, lerpTime)
        return Sequence()

    def putOnSuit(self, suitType, headType = 0, waiter = False, setDisplayName = True, rental = False):
        if self.isDisguised:
            self.takeOffSuit()
        ...
        if rental == True:
            if SuitDNA.suitDepts[deptIndex] == 's':
                suitType = 'cc'
                self.deptName = TTLocalizer.Sellbot
            elif SuitDNA.suitDepts[deptIndex] == 'm':
                suitType = 'sc'
                self.deptName = TTLocalizer.Cashbot
            elif SuitDNA.suitDepts[deptIndex] == 'l':
                suitType = 'bf'
                self.deptName = TTLocalizer.Lawbot
            elif SuitDNA.suitDepts[deptIndex] == 'c':
                suitType = 'f'
                self.deptName = TTLocalizer.Bossbot
            else:
                self.notify.warning(':Toon(suspicious): Incorrect rental suit department requested')
                suitType = 'cc'
                self.deptName = TTLocalizer.Sellbot
        else:
            if SuitDNA.getSuitDept(deptIndex) == 's':
                self.deptName = TTLocalizer.Sellbot
            elif SuitDNA.getSuitDept(deptIndex) == 'm':
                self.deptName = TTLocalizer.Cashbot
            elif SuitDNA.getSuitDept(deptIndex) == 'l':
                self.deptName = TTLocalizer.Lawbot
            elif SuitDNA.getSuitDept(deptIndex) == 'c':
                self.deptName = TTLocalizer.Bossbot
            elif SuitDNA.getSuitDept(deptIndex) == 'z':
                self.deptName = TTLocalizer.Crazybot
        ...
        if setDisplayName:
            ...
            if headType == 1 or suitType == 'sf':
                self.nametag.setText(TTLocalizer.SuitBaseNameWithLevel % {'name': suitName,
                'dept': self.deptName,
                ...
                if suitType == 'sf':
                    ...
                    self.isCogHead = 1
            elif headType == 2 and suitType != 'sf':
                self.nametag.setText(TTLocalizer.SuitBaseNameWithLevel % {'name': 'Skelecog',
                'dept': self.deptName,
                'level': self.cogLevels[suitDept] + 1})
                self.isCogHead = 2
            else:
        ...
        if waiter == True and suitType != 'sf':
            self.makeWaiter()
        print ':Toon: Disguised!!'
    ...
    def takeOffSuit(self):
        ...
        del self.suit
        del self.suitGeom
        print ':Toon(takeOffSuit): Undisguised!!'
        
    def becomeChar(self, charType):
        if self.isTransformed:
            self.becomeToon()
        if launcher and not launcher.getPhaseComplete(5):
            return
        ...
        self.nametag.setText(TTLocalizer.charName2Id[charType])
        print ':Toon(becomeChar): Transformed into %s!!' % self.char.style.getCharName()
    ...
    def becomeToon(self):
        ...
        del self.char
        del self.charGeom
        print ':Toon(becomeToon): ToonIsBack!!'
