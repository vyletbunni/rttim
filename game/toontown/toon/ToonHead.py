...
class ToonHead(Actor.Actor):
    ...
    def generateToonColor(self, style):
        ...
        if animalType == 'cat' or animalType == 'rabbit' or animalType == 'bear' or animalType == 'mouse' or animalType == 'pig' or animalType == 'riggy' or animalType == 'deer' or animalType == 'crocodile' or animalType == 'hedgehog' or animalType == 'fox':
    ...
    def __fixHeadLongLong(self, style, lodName = None, copy = 1):
        ...
        for partNum in xrange(0, otherParts.getNumPaths()):
            if style.getAnimal() == 'deer':
                if partNum == 0 or partNum == 1 or partNum == 3 or partNum == 4 or partNum == 5 or partNum == 6:
                    continue
            if copy:
    ...
    def __fixHeadLongShort(self, style, lodName = None, copy = 1):
        ...
        if lodName == None:
            ...
            searchRoot = self.find('**/' + str(lodName))
        if animalType != 'duck' and animalType != 'horse' and animalType != 'deer':
        ...
        if animalType != 'rabbit' and animalType != 'deer':
            if copy:
                searchRoot.find('**/eyes-short').removeNode()
            else:
                searchRoot.find('**/eyes-short').hide()
        if animalType != 'dog' and animalType != 'deer':
            if copy:
        ...
        if animalType == 'deer' or animalType == 'fox':
            if copy:
                self.find('**/nose-long').removeNode()
            else:
                self.find('**/nose-long').hide()
        if animalType != 'rabbit':
    ...
    def __fixHeadShortLong(self, style, lodName = None, copy = 1):
        ...
        if lodName == None:
            ...
            searchRoot = self.find('**/' + str(lodName))
        if animalType != 'duck' and animalType != 'horse' and animalType != 'deer':
            if animalType == 'rabbit' or animalType == 'riggy':
                if copy:
                    searchRoot.find('**/ears-short').removeNode()
                else:
                    searchRoot.find('**/ears-short').hide()
                ...
                searchRoot.find('**/ears-long').hide()
        if animalType != 'rabbit' and animalType != 'riggy' and animalType != 'deer':
            if copy:
        ...
        if animalType != 'rabbit' and animalType != 'riggy':
            muzzleParts = searchRoot.findAllMatches('**/muzzle-short*')
            for partNum in xrange(0, muzzleParts.getNumPaths()):
                if copy:
                    muzzleParts.getPath(partNum).removeNode()
