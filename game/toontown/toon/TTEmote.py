...
def doShockeyes(toon, volume = 1):
    track = Sequence(Func(toon.surpriseEyes), Func(toon.showSurpriseMuzzle), Func(toon.stopBlink), Wait(10.0), Func(toon.normalEyes), Func(toon.hideSurpriseMuzzle), Func(toon.blinkEyes))
    return (track, 0.1, None)
...
def doNothing(toon, volume = 1):
    track = Sequence(Func(toon.blinkEyes), Func(toon.normalEyes), Func(toon.startBlink), Func(toon.hideSmileMuzzle), Func(toon.hideAngryMuzzle), Func(toon.hideLaughMuzzle), Func(toon.hideSadMuzzle), Func(toon.hideSurpriseMuzzle))
    return (None, 0, None)
...
def doCockBlock(toon, volume = 1):
    track = Sequence(Func(toon.blinkEyes), Func(toon.normalEyes), Func(toon.startBlink), Func(toon.hideSmileMuzzle), Func(toon.hideAngryMuzzle), Func(toon.hideLaughMuzzle), Func(toon.hideSadMuzzle), Func(toon.hideSurpriseMuzzle))
    return (None, 0, None)
    #because im not good with editing commands
