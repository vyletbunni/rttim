...
FlippyPhraseIds = [[100, 101, 102, 103, 104, 105],                       # Hello
                   ...
                   [1520, 1527],                                         # Catch!
                   [1526],                                               # Piece of cake
                   [1112, 1114, 1554, 1555, 1556, 1557, 1559, 812],      # Cogs
                   [1558],                                               # Save powerful gags
                   [5400],                                               # Toontown Offline
                   ...
                   [10105],                                              # Decorations
                   [5700],                                               # Toontastic
                   [1130, 1131, 1132, 1133, 1136],                       # Wait
                   [5406],                                               # Stuck
                   [5411],                                               # Bug report
                   [1600],                                               # One more?
                   [1605],                                               # Need jellybeans
                   [1104, 1105]]                                         # Go to TTC
...
FlippyPhrases = ['Hey there, __NAME__! How are you doing?',
                 ...
                 'Toontown... Offline? I\'ve heard Toons say that a few times, but I can never figure out what they mean.', # Breaking the 4th wall. 
