...
FinaleSuitPhrases = [
    ...
    # We arrive at Flippy
    "Finally. Just the toon I've been searching for.",
...
SuitWaves = [
    ...
    generateSuits(7, [2, 3], [0, 0]), # Wait Wave
    generateSuits(9, [2, 4], [0, 0]), # Intermission Wave

    # WAVE 2:
    generateSuits(6, [2, 3], [0, 1]),
    generateSuits(7, [2, 2], [0, 1]), # Wait Wave
    generateSuits(9, [2, 3], [0, 1]), # Intermission Wave

    # WAVE 3:
    generateSuits(4,  [2, 3], [1, 2]),
    generateSuits(6, [2, 2], [2, 2]), # Wait Wave
    generateSuits(9, [2, 3], [2, 2]), # Intermission Wave

    # WAVE 4:
    generateSuits(4,  [2, 3], [2, 3]),
    generateSuits(6, [2, 2], [3, 3]), # Wait Wave
    generateSuits(9, [2, 3], [3, 3]), # Intermission Wave

    # WAVE 5:
    generateSuits(4,  [0, 2], [3, 4]),
    generateSuits(6, [2, 4], [4, 4]), # Wait Wave
    generateSuits(9, [2, 3], [4, 4]), # Intermission Wave

    # WAVE 6:
    generateSuits(4,  [1, 2], [4, 5]),
    generateSuits(6, [1, 4], [5, 5], True), # Wait Wave
    generateSuits(8, [2, 3], [5, 5], True), # Intermission Wave

    # WAVE 7:
    generateSuits(4,  [0, 2], [5, 6], True),
    generateSuits(6, [1, 2], [6, 6], True), # Wait Wave
    generateSuits(8, [2, 3], [6, 6], True), # Intermission Wave

    # WAVE 8:
    generateSuits(8, [1, 3], [6, 7], True),
    generateSuits(8, [1, 4], [7, 7], True), # Wait Wave
    generateSuits(8, [2, 4], [7, 7], True), # Intermission Wave

    # WAVE 9: THE FINAL WAVE
    generateSuits(8, [1, 3], [6, 7], True),
    generateSuits(10, [1, 4], [7, 7], True), # Wait Wave
    generateSuits(10, [2, 4], [7, 7], True), # Intermission Wave
]
...
# This message is displayed upon trying to board the trolley
BoardTrolleyAlert = "You can't board the trolley right now, the Gag Shop is closed for the election!"
