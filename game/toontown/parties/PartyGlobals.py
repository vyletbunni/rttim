...
TrampolineJellyBeanBonus = 20
TrampolineMaxHeight = 100
...
PartyCannonCollisions = {'clouds': ['cloudSphere-0'],
 'bounce': ['wall_collision',
            ...
            'collision_lock',
            'collision_dividers',
            'collision_tf_tower_mid',
            'collision_tf_tower_mid1',
            'collision_tf_tower_baseroof',
            'top_floor_collision',
            'rail_collision',
            'mountain_collision',
            'collisions_mountain',
