...
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 100: 'You have been disconnected because someone else just logged in using your account on another computer.  Go get it back!',
 ...
 124: 'Your installed files are out of date.  We\'d prefer if you wouldn\'t use an open source version of the game, but if you\'re not, then contact support.',
 ...
 152: "Oh shit. I think the account '%(name)s' got banned. You should check the e-mail associated with '%(name)s'.",
 ...
 154: 'Toontown' + unttid + ' is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toontown Infinite website.',
...
CRMaintenanceCountdownMessage = 'Attention Toons! The game will be going down for maintenance in %d minutes.'
CRMaintenanceMessage = 'Attention Toons! The game is now going down for maintenance.'
...
FriendSecretIntro = "If you are playing Toontown" + unttid + " with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toontown' + unttid + ' network'
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 30500: "Welcome to Toontown" + unttid + "!",
 30501: "Because first amendment.",
 30502: "Are you livestreaming?",
 30503: "I'm livestreaming right now!",
 30504: "I can't wait until the next update!",
 30505: "Did you know the TTFS team works overtime to make the experience the best it can be?",
